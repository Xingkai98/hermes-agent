...
fireworks = ProviderProfile(
    ...
    # actually serves on chat completions (e.g. minimax-m3 and glm-5p1 are
    # callable but not listed), so we keep the most useful models here so
    # they always show in the picker.
    fallback_models=(
