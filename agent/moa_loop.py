...
_REFERENCE_SYSTEM_PROMPT = (
    ...
    "actual actions.\n\n"
    "Everything you output is consumed as plaintext by the aggregator model — "
    "NOT parsed for tool calls, function invocations, or structured actions. "
    "Do NOT emit JSON, XML, or any format that looks like a tool call; the "
    "aggregator will not execute it and may misinterpret it as a successful "
    "result, leading to incorrect behavior.\n\n"
