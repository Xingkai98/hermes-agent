...
def _build_call_kwargs(
    ...
    if max_tokens is not None:
        ...
        if (
            ...
            # All other providers: use auxiliary_max_tokens_param() to pick the
            # correct wire field (max_tokens vs max_completion_tokens per model).
            # The retry logic in call_llm catches 400 errors from providers that
            # reject the parameter outright and strips it on retry.
            kwargs.update(
